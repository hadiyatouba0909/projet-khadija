...
const About = () => {
  ...
  const slides = [
    ...
    {
      id: 4,
      title: t('about.our_partners.title'), // Changé de 'our_values' à 'our_partners'
      content: t('about.our_partners.content'), // Changé de 'our_values' à 'our_partners'
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Grid des slides avec animations - Responsive pour 4 cartes */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-20">
          {slides.map((slide, index) => (
            <div
              key={slide.id}
              data-index={index}
              className={`about-card bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 group cursor-pointer border border-gray-100 overflow-hidden relative ${visibleItems.includes(index)
